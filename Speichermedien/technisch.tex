...
%% ==============================  
	...
	Alle Speichermedien die Daten auf Basis von elektronischen Bauelementen speichern sind unter dem Begriff elektronische Speicher zusammengefasst. Heutzutage werden die integrierten Schaltkreise, die zur elektrischen Speicherung notwendig sind fast nur noch mit Silizium realisert. Die einzelnen Speicherzellen k"onnen beliebig angesprochen werden, es ist also keine weitere Teilung des Speichers in Sequenzen notwendig. Weiter unterschieden werden elektronische Speichermedien in fl"uchtige Speicher, permanente Speicher und semi-permanente Speicher.
        ...
        \subsection{Permanente Speicher}
        %% ==============================
        \label{ch:Technisch:sec:Elektronische Speicherung:sub:Permanente Speicher}
        %% ==============================
            ...
            Permanenter Speicher beh"alt seine Daten, die einmal in ihm gespeichert oder verdrahtet wurde. Er kann dann nicht mehr ver"andert werden.
				...
				%% ==============================
					...
					Ein typisches Beispiel f"ur permante Speicher ist der \glqq Read Only Memory\grqq{} --- zu Deutsch \textit{Festwertspeicher} oder \textit{Nur-Lese-Speicher}. ROM kann nur einmal beschrieben werden, dann lassen sich die darauf geschriebenen Daten nicht mehr ver"andern. 
					\\
        ...
        \subsection{Semi-permanente Speicher}
        %% ==============================
        \label{ch:Technisch:sec:Elektronische Speicherung:sub:Semi-permanente Speicher}
        %% ==============================
            ...
            Von semi-permanenten Speichern spricht man, wenn die Daten permanent gespeichert werden, aber im Gegensatz zum permanenten Speicher auch wieder ver"andert werden k"onnen. 
				...
				%% ==============================
					...
					\\
					Weiterhin gibt es noch elektronisch l"oschbaren Speicher EEPROM(\glqq Electrical Erasable Read Only Memory\grqq{}), welches mit Flash-EEPROM den herk"ommlichen EPROM verdr"angt hat.
				...
				%% ==============================
					...
					\\
					Durch seine kompakten Ma"se ist er sehr portabel und die mittlerweile g"angigen Speichergr"o"sen reichen von 2 Gigabyte bis zu 256 GB\footnote{Stand: 22. Juni 2012}. Er l"asst sich an jeden USB-Host anschlie"sen, Daten lassen sich so einfach austauschen. 
					\\
				...
				\end{figure}
				\\
				Durch die immer weiter sinkenden Preise pro Gigabyte und die unumst"o"slichen Vorteile ist eine dauerfristige Abl"osung von magnetischen Fesplatten in naher Zukunft durch Solid State Drives zu sehen.
...
\end{table}
        ...
        %% ==============================
            ...
            Die Blu-ray Disc Association\footnote{Im Februar 2002 gründeten neun führende Elektronikfirmen, darunter Matsushita, Pioneer, Phillips, Thomson, LG Electronics, Hitachi, Sharp, Samsung und Sony die Blu-ray Disc Founders. Zu einem späteren Zeitpunkt benannte sich die Vereinigung in Blu-ray Disc Association um.} stellte 2002 die Blu-ray Disc vor. Der Name zielt auf den Abtastlaser ab, der eine violette Farbe hat. Blu\textbf{e} Ray wurde absichtlich falsch geschrieben, um die Registrierung als Namen zu vereinfachen. Die Blu-ray setzte sich 2008 gegen den Konkurrenten HD-DVD\footnote{High Definition DVD, vom DVD-Forum vorgestelltes Konkurrenzprodukt. Das DVD-Forum besteht aus mehr als 230 Unternehmen.} durch und fasst schon mit einem Single Layer 25 Gigabyte.\cite{Wojciechowski:bluray} Der Markt f"ur hochaufl"osende Filme war damit f"ur den Endverbraucher ge"offnet.
            \\
